...
assert(html.includes('id="colorSwatchRing"'), "Must have colorSwatchRing in viewer.html");
...
assert(js.includes("function positionSwatchesInRing()"), "Must position swatches circularly in a ring");
