...
7. In the Interactive Studio tab:
   ...
   - **Zoom & Focus:** Use mouse wheel, pan, press **F** for one-time focus, press **H** to toggle **Show/Hide Focus Spotlight (👁️)**, customize **Spotlight Color 🎨** with quick palette swatches, or press **A** to toggle **Auto Focus (🎯)** mode across all steps.
